namespace Random
{
    partial class about
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "产品名称    随机点名软件";
            ...
            this.labelVersion.Text = "版本        V1.1";
            ...
            this.textBoxDescription.Text = "*1. 通过导入Excel文档(97-03)*.xls，文件获取学生名单(以首师大教务处名单格式为基准)，并在程序所在目录产生工程文件，使用照片请建立photos" +
    "文件夹并以学号为文件名存储照片(jpg格式)。\r\n*2. 点名时请不要打开Excel，如果提示文件被占用，请在任务管理器中关闭Excel实例。\r\n*3. 导出报" +
    "表会以课程名命名，复选框中选择要导出的日期。";
            // 
            // okButton
            // 
